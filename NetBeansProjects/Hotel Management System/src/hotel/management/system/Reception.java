...
public class Reception extends JFrame implements ActionListener{
     ...
     JButton newcust , rooms, department, allemployee, managerinfo , custinfo, searchroom, update , roomstatus, pickup, checkout,logout;
    ...
    Reception(){
       ...
       checkout = new JButton("Checkout");
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/r3.jpg"));
